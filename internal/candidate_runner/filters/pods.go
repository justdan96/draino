...
func NewPodFilter(logger logr.Logger, group string, podFilter kubernetes.PodFilterFunc, objectsStore kubernetes.RuntimeObjectStore) Filter {
	return FilterFromFunctionWithReason("pods", group,
