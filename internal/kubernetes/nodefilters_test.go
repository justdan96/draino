...
func TestParseConditions(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			expect:     []SuppliedCondition{{ID: "Ready", Type: core.NodeConditionType("Ready"), Status: core.ConditionStatus("True"), parsedDelay: 0, parsedExpectedResolutionTime: DefaultExpectedResolutionTime}},
		},
		{
			name:       "Mixed",
			conditions: []string{"Ready", `OutOfDisk={ "delay":"10m"}`},
			expect: []SuppliedCondition{
				{ID: "Ready", Type: core.NodeConditionType("Ready"), Status: core.ConditionStatus("True"), parsedDelay: 0, parsedExpectedResolutionTime: DefaultExpectedResolutionTime},
				{ID: "OutOfDisk", Type: core.NodeConditionType("OutOfDisk"), Status: core.ConditionStatus("True"), parsedDelay: 10 * time.Minute, Delay: "10m", parsedExpectedResolutionTime: DefaultExpectedResolutionTime},
			},
		},
		{
			name:       "NewFormat",
			conditions: []string{`ready-unknown={"type":"Ready","conditionStatus":"Unknown","delay":"30m"}`},
			expect:     []SuppliedCondition{{ID: "ready-unknown", Type: core.NodeConditionType("Ready"), Status: core.ConditionStatus("Unknown"), parsedDelay: 30 * time.Minute, Delay: "30m", parsedExpectedResolutionTime: DefaultExpectedResolutionTime}},
		},
		{
			...
			expect:     []SuppliedCondition{{ID: "Ready", Type: core.NodeConditionType("Ready"), Status: core.ConditionStatus("Unknown"), parsedDelay: 30 * time.Minute, Delay: "30m", parsedExpectedResolutionTime: 24 * time.Hour, ExpectedResolutionTime: "24h"}},
		},
		{
			name:       "FormatError",
