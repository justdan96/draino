	...
	tests := []struct {
		...
		},
		{
			...
			Objects: []runtime.Object{
				...
				createPDB(createPDBOpts{Name: "foo-pdb", Labels: testLabels, Annotations: map[string]string{"disruption-budget-manager.datadoghq.com/no-budget-reason": "lockness[test]"}, Des: 2, Healthy: 2}),
			},
		},
		{
